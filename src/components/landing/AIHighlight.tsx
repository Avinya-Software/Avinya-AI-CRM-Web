        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-display font-bold leading-tight text-slate-900 dark:text-white"
            >
              Your CRM, <br />
              <span className="text-gradient">Now with an AI Assistant.</span>
            </motion.h2>
